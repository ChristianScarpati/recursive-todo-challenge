...
import { createNewUser, createSession } from "../lib/appwrite.server";
import { commitSession, getSession } from "../sessions.server";

export function meta({ }: Route.MetaArgs) {
    return [{ title: "Sign Up - Todo App" }];
}
                    ...
                    <div className="-space-y-px rounded-md shadow-sm">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="name"
                                type="text"
                                className="relative block w-full border-0 py-1.5 px-2 text-black font-bold bg-white ring-1 ring-inset ring-gray-300 placeholder:text-gray-500 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
